...
const User = () => {
  return (
    <section className="relative w-full  px-12 md:px-32 min-h-[1100px]  md:min-h-[500px]  mb-10">
      <div className="absolute bg-white  rounded-lg flex flex-col md:flex-row justify-between items-start top-[-15%] md:top-[-20%] w-[80%] xs:w-[85%]  md:w-[80%] border pb-8 ">
        {/* About */}

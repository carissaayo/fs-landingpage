...
const BuyHero = () => {
  return (
    <section className=" w-full md:min-h-screen  text-center md:text-left  px-12 md:px-32   bg-[#0E0C4D]  text-white relative poppins-regular md:mt-[-80px] py-10 pb-36 md:pb-10 ">

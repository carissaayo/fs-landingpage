...
const SellForm = () => {
  return (
    <div className="bg-white w-[85%]  border border-gray-200 rounded-xl  min-h-[150px] flex flex-col md:flex-row items-center justify-center md:justify-start px-8 absolute top-[-5%] py-8 md:py-0 z-10 gap-8 md:gap-0">
      <div className="w-[90%] md:flex-[1.5] flex flex-col justify-start mx-auto  ">
        ...
        <div className="flex items-center gap-3 mt-4  border lg:border-b border-gray-400 py-4 md:py-2 md:w-4/5 px-4 rounded-xl h-[60px]">
      ...
      <div className="w-full md:flex-1 md:border-x px-4  flex flex-col justify-start gap-4 ">
        ...
        <div className="custom-select">
          <select className="border border-gray-400 p-4 rounded-lg">
